...
var sketch = 1;
var answer_holder = "";
var score = 0; var item; var accuracy;
...
{
  timer_counter++;
  document.getElementById("timer").innerHTML = "Timer: " + timer_counter.toString();
  ...
  // const myTimeout = setTimeout(checkSketch, 400);
}
...
function updateCanvas()
{
  ...
  draw_sketch = quick_draw_data_set[random_number];
  console.log(draw_sketch);
  document.getElementById("sketchDraw").innerHTML = "Sketch to draw: " + draw_sketch.toString();
}
...
document.getElementById("label").innerHTML = "Item drawn : " + result[0].label;
